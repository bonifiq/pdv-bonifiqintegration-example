...
export const mockRewardsData: Record<number, MockRewardConfig> = {
  ...
  461: { id: 461, title: 'Caneca', rewardType: RewardType.ProductDiscount, points: 0, minPurchase: 0, rewardCanBeCumulative: false, externalProductId: 'P009', productDisplayName: 'Caneca', productDiscountMode: ProductDiscountMode.FixedFinalPrice, productDiscountValue: 0.01, productMaxUnitsPerRedeem: 1, productAvailableQuantity: 1 },
  463: { id: 463, title: 'R$ 10,00 no Boné Esportivo', rewardType: RewardType.ProductDiscount, points: 0, minPurchase: 0, rewardCanBeCumulative: true, externalProductId: 'P004', productDisplayName: 'Boné Esportivo', productDiscountMode: ProductDiscountMode.FixedDiscountAmount, productDiscountValue: 10, productMaxUnitsPerRedeem: 3, productAvailableQuantity: 10 },
}
